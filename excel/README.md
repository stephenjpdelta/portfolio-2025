...
analysis, and reporting. The focus is on producing clear, structured outputs

from raw tabular data using built-in Excel functionality.
...
data administration and analyst roles, with an emphasis on accuracy,
